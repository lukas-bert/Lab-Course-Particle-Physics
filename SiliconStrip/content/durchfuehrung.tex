...
the CCE gets until a maximum is reached at $U_{dep}$. This is when the sensor is fully depleted. The CCE can be 
...
the control unit. It can be read out with an accuracy of $\qty{0.01}{\micro\metre}$.\\
